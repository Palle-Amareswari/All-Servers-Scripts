# This will work in linux machines only if you need to setup in ubuntu machines change it accordingly
...
#If you need to setup in worker nodes clusters you can replace with your ip addresses and uncomment below 3 lines.
